...
- [x] I want to be able rename agents
- [x] I want to be able to delete sessions
...
- [x] Plan for extending agents to work with multi repos and for the context logic to updated to work per project
